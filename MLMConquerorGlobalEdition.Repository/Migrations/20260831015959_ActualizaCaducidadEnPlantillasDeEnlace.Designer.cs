...
namespace MLMConquerorGlobalEdition.Repository.Migrations
{
    ...
    [Migration("20260831015959_ActualizaCaducidadEnPlantillasDeEnlace")]
    partial class ActualizaCaducidadEnPlantillasDeEnlace
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Billing.ApiCredential", b =>
                {
                    ...
                    b.Property<string>("SpreedlyGatewayTokenEncrypted")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Billing.RecurringBillingBatch", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("RunDate", "Gateway");

                    b.ToTable("RecurringBillingBatches");
                });

            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Billing.RecurringBillingBatchShard", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("AssignedWorkerKey")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<long>("IdRangeEnd")
                        .HasColumnType("bigint");

                    b.Property<long>("IdRangeStart")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("BatchId", "ShardIndex")
                        .IsUnique();

                    b.HasIndex("BatchId", "Status");

                    b.ToTable("RecurringBillingBatchShards");
                });
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Billing.SubscriptionBillingState", b =>
                {
                    ...
                    b.Property<long>("ShardKey")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ShardKey"));
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Commission.CommissionTriggerQueue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("BatchId", "IsProcessed");

                    b.ToTable("CommissionTriggerQueues");
                });
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Commission.PointDeltaEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("DualTeamDelta")
                        .HasColumnType("int");

                    b.Property<int>("EnrollmentDelta")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Member.MemberProfile", b =>
                {
                    ...
                    b.Property<string>("EinEncrypted")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Membership.MembershipSubscription", b =>
                {
                    ...
                    b.Property<int>("DualTeamContribution")
                        .HasColumnType("int");

                    b.Property<DateTime?>("EndDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("EnrollmentContribution")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PersonalContribution")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Orders.CryptoPaymentConfirmation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("CryptoPaymentConfirmations");
                });
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Security.AuthSecurityEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ChallengeJti")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasIndex("EventType", "CreationDate");

                    b.HasIndex("OperationKey", "CreationDate");

                    b.HasIndex("UserId", "CreationDate");

                    b.ToTable("AuthSecurityEvents");
                });

            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Security.StepUpPolicy", b =>
                {
                    b.Property<string>("OperationKey")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<int?>("RequiredChannel")
                        .HasColumnType("int");

                    b.HasKey("OperationKey");

                    b.ToTable("StepUpPolicies");
                });

            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Sms.SmsTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Sms.SmsTemplateLocalization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SmsTemplateId", "LanguageCode")
                        .IsUnique();

                    b.ToTable("SmsTemplateLocalizations");
                });
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Wallet.MemberCreditCard", b =>
                {
                    ...
                    b.Property<string>("SpreedlyPaymentMethodToken")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Repository.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("PreferredTwoFactorChannel")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("TwoFactorPhoneConfirmed")
                        .HasColumnType("bit");

                    b.Property<string>("TwoFactorPhoneEncrypted")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("TwoFactorPhoneLast4")
                        .HasMaxLength(4)
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Billing.RecurringBillingBatchShard", b =>
                {
                    b.HasOne("MLMConquerorGlobalEdition.Domain.Entities.Billing.RecurringBillingBatch", "Batch")
                        .WithMany("Shards")
            ...
            modelBuilder.Entity("MLMConquerorGlobalEdition.Domain.Entities.Sms.SmsTemplateLocalization", b =>
                {
                    b.HasOne("MLMConquerorGlobalEdition.Domain.Entities.Sms.SmsTemplate", "SmsTemplate")
                        .WithMany("Localizations")
