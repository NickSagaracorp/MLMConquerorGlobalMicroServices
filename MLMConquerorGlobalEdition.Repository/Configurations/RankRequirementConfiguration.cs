...
public class RankRequirementConfiguration : IEntityTypeConfiguration<RankRequirement>
{
    public void Configure(EntityTypeBuilder<RankRequirement> builder)
    {
        ...
        // ═══════════════════════════════════════════════════════════════════════
        // RANK REQUIREMENTS — full 19-rank comp plan table
        // TeamPoints for Silver/Gold/Platinum = Enrollment Team points.
        // TeamPoints for Titanium+ = Dual Team points.
        // DailyBonus = DTR daily payout amount (corresponds to DTR CommissionType).
        // MaxTeamPointsPerBranch = 0.5 (no leg > 50% of total qualifying points).
        // RankBonus = one-time achievement bonus paid on first qualifying to this rank.
        ...
        builder.HasData(
            ...
            new RankRequirement
            {
                ...
                TeamPoints = 18, MaxTeamPointsPerBranch = 0.5,
                EnrollmentTeam = 3, SponsoredMembers = 1, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                TeamPoints = 72, MaxTeamPointsPerBranch = 0.5,
                EnrollmentTeam = 12, SponsoredMembers = 1, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                TeamPoints = 175, MaxTeamPointsPerBranch = 0.5,
                EnrollmentTeam = 29, SponsoredMembers = 2, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 2, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 3, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 4, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 5, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 6, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 7, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 8, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 10, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 12, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 15, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 20, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 25, PersonalPoints = 1,
            ...
            new RankRequirement
            {
                ...
                EnrollmentTeam = 0, SponsoredMembers = 30, PersonalPoints = 1,
