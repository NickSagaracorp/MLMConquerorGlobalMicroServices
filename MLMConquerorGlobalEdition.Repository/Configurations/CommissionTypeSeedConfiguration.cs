...
/// Amount is determined per-transaction by the token engine; FixedAmount here
    ...
    public void Configure(EntityTypeBuilder<CommissionType> builder)
    {
        ...
        builder.HasData(
            ...
            new CommissionType
            {
                ...
                Percentage  = 0m, FixedAmount = 150m,
                PaymentDelayDays = 0,
                IsActive = true, IsRealTime = true,
            ...
            new CommissionType { Id = 7,  CommissionCategoryId = 3, Name = "DTR – Silver",        Description = "Earn $4/day when qualifying at Silver rank (18 Enrollment Team points).",       Percentage = 0m, FixedAmount = 4m,     PaymentDelayDays = 4, TeamPoints = 18,     IsActive = true, ResidualBased = true, IsEnrollmentBased = true,  CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 8,  CommissionCategoryId = 3, Name = "DTR – Gold",          Description = "Earn $10/day when qualifying at Gold rank (72 Enrollment Team points).",       Percentage = 0m, FixedAmount = 10m,    PaymentDelayDays = 4, TeamPoints = 72,     IsActive = true, ResidualBased = true, IsEnrollmentBased = true,  CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 9,  CommissionCategoryId = 3, Name = "DTR – Platinum",      Description = "Earn $15/day when qualifying at Platinum rank (175 Enrollment Team points).",  Percentage = 0m, FixedAmount = 15m,    PaymentDelayDays = 4, TeamPoints = 175,    IsActive = true, ResidualBased = true, IsEnrollmentBased = true,  CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 10, CommissionCategoryId = 3, Name = "DTR – Titanium",      Description = "Earn $25/day when qualifying at Titanium rank (350 Dual Team points).",        Percentage = 0m, FixedAmount = 25m,    PaymentDelayDays = 4, TeamPoints = 350,    IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 11, CommissionCategoryId = 3, Name = "DTR – Jade",          Description = "Earn $40/day when qualifying at Jade rank (700 Dual Team points).",            Percentage = 0m, FixedAmount = 40m,    PaymentDelayDays = 4, TeamPoints = 700,    IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 12, CommissionCategoryId = 3, Name = "DTR – Pearl",         Description = "Earn $80/day when qualifying at Pearl rank (1,500 Dual Team points).",         Percentage = 0m, FixedAmount = 80m,    PaymentDelayDays = 4, TeamPoints = 1500,   IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 13, CommissionCategoryId = 3, Name = "DTR – Emerald",       Description = "Earn $150/day when qualifying at Emerald rank (3,000 Dual Team points).",      Percentage = 0m, FixedAmount = 150m,   PaymentDelayDays = 4, TeamPoints = 3000,   IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 14, CommissionCategoryId = 3, Name = "DTR – Ruby",          Description = "Earn $300/day when qualifying at Ruby rank (6,000 Dual Team points).",         Percentage = 0m, FixedAmount = 300m,   PaymentDelayDays = 4, TeamPoints = 6000,   IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 15, CommissionCategoryId = 3, Name = "DTR – Sapphire",      Description = "Earn $500/day when qualifying at Sapphire rank (10,000 Dual Team points).",    Percentage = 0m, FixedAmount = 500m,   PaymentDelayDays = 4, TeamPoints = 10000,  IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 16, CommissionCategoryId = 3, Name = "DTR – Diamond",       Description = "Earn $750/day when qualifying at Diamond rank (15,000 Dual Team points).",     Percentage = 0m, FixedAmount = 750m,   PaymentDelayDays = 4, TeamPoints = 15000,  IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 17, CommissionCategoryId = 3, Name = "DTR – Double Diamond",Description = "Earn $1,000/day when qualifying at Double Diamond (20,000 DT points).",        Percentage = 0m, FixedAmount = 1000m,  PaymentDelayDays = 4, TeamPoints = 20000,  IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 18, CommissionCategoryId = 3, Name = "DTR – Triple Diamond",Description = "Earn $1,500/day when qualifying at Triple Diamond (30,000 DT points).",        Percentage = 0m, FixedAmount = 1500m,  PaymentDelayDays = 4, TeamPoints = 30000,  IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 19, CommissionCategoryId = 3, Name = "DTR – Blue Diamond",  Description = "Earn $2,000/day when qualifying at Blue Diamond (60,000 DT points).",          Percentage = 0m, FixedAmount = 2000m,  PaymentDelayDays = 4, TeamPoints = 60000,  IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 20, CommissionCategoryId = 3, Name = "DTR – Black Diamond", Description = "Earn $3,000/day when qualifying at Black Diamond (120,000 DT points).",        Percentage = 0m, FixedAmount = 3000m,  PaymentDelayDays = 4, TeamPoints = 120000, IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 21, CommissionCategoryId = 3, Name = "DTR – Royal",         Description = "Earn $4,000/day when qualifying at Royal rank (200,000 DT points).",           Percentage = 0m, FixedAmount = 4000m,  PaymentDelayDays = 4, TeamPoints = 200000, IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 22, CommissionCategoryId = 3, Name = "DTR – Double Royal",  Description = "Earn $5,000/day when qualifying at Double Royal (300,000 DT points).",         Percentage = 0m, FixedAmount = 5000m,  PaymentDelayDays = 4, TeamPoints = 300000, IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 23, CommissionCategoryId = 3, Name = "DTR – Triple Royal",  Description = "Earn $7,500/day when qualifying at Triple Royal (400,000 DT points).",         Percentage = 0m, FixedAmount = 7500m,  PaymentDelayDays = 4, TeamPoints = 400000, IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 24, CommissionCategoryId = 3, Name = "DTR – Blue Royal",    Description = "Earn $10,000/day when qualifying at Blue Royal (500,000 DT points).",          Percentage = 0m, FixedAmount = 10000m, PaymentDelayDays = 4, TeamPoints = 500000, IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            new CommissionType { Id = 25, CommissionCategoryId = 3, Name = "DTR – Black Royal",   Description = "Earn $15,000/day when qualifying at Black Royal (700,000 DT points).",         Percentage = 0m, FixedAmount = 15000m, PaymentDelayDays = 4, TeamPoints = 700000, IsActive = true, ResidualBased = true, CreationDate = SeedDate, CreatedBy = "seed" },
            ...
            new CommissionType
            {
                ...
                Percentage  = 0m, FixedAmount = 600m,
                PaymentDelayDays = 15,
            ...
            new CommissionType
            {
                ...
                Percentage  = 0m, FixedAmount = 1200m,
                PaymentDelayDays = 15,
                IsActive = true, IsRealTime = false,
                NewMembers  = 12,
                TriggerOrder = 2,
            ...
            new CommissionType
            {
                ...
                Percentage  = 20m, FixedAmount = null,
                PaymentDelayDays = 15,
                IsActive = true, IsRealTime = false,
            ...
            new CommissionType
            {
                ...
                Percentage  = 0m, FixedAmount = null,
                PaymentDelayDays = 0,
                IsActive = true, IsRealTime = true,
                CreationDate = SeedDate, CreatedBy = "seed"
            },
            ...
            new CommissionType
            {
                ...
                Percentage  = 0m, FixedAmount = 120m,
                PaymentDelayDays = 4,
                IsActive = true, IsRealTime = true,
                IsPaidOnSignup = true, IsSponsorBonus = true,
                LevelNo = 4,
            ...
            new CommissionType
            {
                ...
                Percentage  = 0m, FixedAmount = 160m,
                PaymentDelayDays = 4,
                IsActive = true, IsRealTime = true,
                IsPaidOnSignup = true, IsSponsorBonus = true,
                LevelNo = 4,
            ...
            // Token Deduction: deducted in real-time per token consumed; FixedAmount
            ...
            new CommissionType
            {
                ...
                Percentage  = 5m, FixedAmount = null,
                PaymentDelayDays = 0,
                IsActive = true, IsRealTime = false,
