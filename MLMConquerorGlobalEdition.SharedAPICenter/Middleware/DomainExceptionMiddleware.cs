...
namespace MLMConquerorGlobalEdition.SharedAPICenter.Middleware;

/// <summary>
/// Global exception middleware.
/// - DomainException  → HTTP 422 Unprocessable Entity with structured ApiResponse.
/// - Any other exception → HTTP 500 Internal Server Error with structured ApiResponse.
///
/// IErrorTrackingService is scoped, so it is injected per-request via method injection
/// rather than through the constructor (which would force it to be singleton-scoped).
/// </summary>
